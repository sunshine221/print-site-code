  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <Link to={props.backTo} className="inline-flex items-center gap-2 text-sm text-zinc-300 hover:text-zinc-50">
      ...
      <div className="mt-6 rounded-2xl border border-zinc-800 bg-zinc-950 p-5">
        <div className="flex items-start justify-between gap-6">
          <div>
            <div className="text-2xl font-semibold text-zinc-50">{props.title}</div>
            <div className="mt-2 text-sm text-zinc-400">{props.subtitle}</div>
          </div>
          <div className="hidden rounded-xl border border-zinc-800 bg-zinc-950 px-3 py-2 text-xs text-zinc-400 md:block">
        ...
        {isProduct ? (
          <div className="mt-6 rounded-xl border border-zinc-800 bg-zinc-950 p-4">
            <div className="text-sm font-semibold text-zinc-50">当前选择</div>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <div>
            <label className="text-xs text-zinc-400">电话</label>
            <input
              value={props.phone}
          ...
          <div>
            <label className="text-xs text-zinc-400">公司</label>
            <input
              value={props.company}
          ...
          <div>
            <label className="text-xs text-zinc-400">数量</label>
            <input
              type="number"
              min={1}
          ...
          <div>
            <label className="text-xs text-zinc-400">交期偏好</label>
            <input
          ...
          <div>
            <label className="text-xs text-zinc-400">工艺偏好</label>
            <input
          ...
          <div>
            <label className="text-xs text-zinc-400">材料偏好</label>
            <input
          ...
          <div className="md:col-span-2">
            <label className="text-xs text-zinc-400">精度偏好</label>
            <input
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              className="mt-2 min-h-24 w-full rounded-md border border-zinc-800 bg-zinc-950 px-3 py-2 text-sm text-zinc-100 outline-none focus:border-zinc-700"
        ...
        {props.error ? (
          <div className="mt-5 rounded-xl border border-zinc-800 bg-zinc-950 p-4 text-sm text-rose-300">
            {props.error}
          </div>
        ) : null}
        ...
        {props.okId ? (
          <div className="mt-5 rounded-xl border border-emerald-900/60 bg-emerald-950/20 p-4">
            ...
            <div className="mt-1 text-xs text-emerald-200/80">线索编号：{props.okId}</div>
          </div>
        ) : null}
      </div>
    </div>
