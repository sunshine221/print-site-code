      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-10">
        <div className="grid gap-8 md:grid-cols-12">
          <div className="md:col-span-7">
            <div className="text-2xl font-semibold text-zinc-50">代打服务</div>
            <div className="mt-3 text-sm leading-relaxed text-zinc-300">
              适合研发打样、功能验证、小批量试产。无需先浏览产品库，直接进入服务详情并上传文件获取报价。
            </div>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              {bullets.map((b) => {
                const Icon = b.icon
                return (
                  <div key={b.title} className="rounded-2xl border border-zinc-800 bg-zinc-950 p-5">
                    <div className="flex items-center gap-2 text-sm font-semibold text-zinc-50">
                      <Icon className="h-4 w-4 text-cyan-300" />
                      {b.title}
                    </div>
                    <div className="mt-2 text-xs text-zinc-400">{b.desc}</div>
                  </div>
                )
              })}
            </div>
            ...
            <div className="mt-8 rounded-2xl border border-zinc-800 bg-zinc-950 p-5">
              <div className="text-sm font-semibold text-zinc-50">报价影响因素</div>
          ...
          <div className="md:col-span-5">
            <div className="sticky top-24 rounded-2xl border border-zinc-800 bg-zinc-950 p-5">
              <div className="text-sm font-semibold text-zinc-50">开始询价</div>
              ...
              <div className="mt-6">
                <Link
                  ...
                  className="inline-flex w-full items-center justify-center gap-2 rounded-md bg-zinc-50 px-5 py-3 text-sm font-semibold text-zinc-950 transition hover:bg-white"
                >
                  上传文件获取报价
              ...
              <div className="mt-3">
                <Link
                  to="/work"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-md border border-zinc-800 bg-zinc-950 px-5 py-3 text-sm font-semibold text-zinc-50 transition hover:bg-zinc-900"
                >
                  我想选平台产品
                  <ArrowUpRight className="h-4 w-4" />
                </Link>
